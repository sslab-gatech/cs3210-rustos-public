...
boolean DWHCIDeviceInitialize (TDWHCIDevice *pThis)
{
  ...
  LogWrite (FromDWHCI, LOG_ERROR, "register");
  ...
  LogWrite (FromDWHCI, LOG_ERROR, "set power state on");
  ...
  LogWrite (FromDWHCI, LOG_ERROR, "disable all interrupt");
  ...
  LogWrite (FromDWHCI, LOG_ERROR, "enable global interrupts");
  ...
  LogWrite (FromDWHCI, LOG_ERROR, "enable root port");
  ...
  LogWrite (FromDWHCI, LOG_ERROR, "rootport initialize");
  ...
  LogWrite (FromDWHCI, LOG_ERROR, "register ahbconfig");
	_DWHCIRegister (&AHBConfig);
  LogWrite (FromDWHCI, LOG_ERROR, "register vendorid");
	_DWHCIRegister (&VendorId);

  LogWrite (FromDWHCI, LOG_ERROR, "done");
	return TRUE;
}
...
boolean DWHCIDeviceEnableRootPort (TDWHCIDevice *pThis)
{
  ...
  LogWrite (FromDWHCI, LOG_ERROR, "_DWHCIRegister (&HostPort)");
	_DWHCIRegister (&HostPort);
...
TUSBSpeed DWHCIDeviceGetPortSpeed (TDWHCIDevice *pThis)
{
  ...
  LogWrite (FromDWHCI, LOG_ERROR, "port speed");
